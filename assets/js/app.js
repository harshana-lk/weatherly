      ...
      card.innerHTML = `
              ...
              <div class="highlight-list">
                <div class="card card-sm highlight-card one">
                  <h3 class="title-3">Air Quality ${aqi}</h3>
                  <div class="wrapper">
                  ...
                  <span class="badge api-${aqi} label-${aqi}" title="
                  ...
                  <div class="card-list">
                    <div class="card-item">
                      ...
                      <div>
                        ...
                        <p class="title-1">
                        ${module.getTime(sunriseUnixUTC, timezone)}</p>
                      </div>
                    </div>
                    <div class="card-item">
                ...
                <div class="card card-sm highlight-card">
                  ...
                  <div class="wrapper">
                    ...
                    <p class="title-1">
                    ${parseInt(feels_like)}&deg<sup>c</sup></p>
                  </div>
                </div>
              </div>
      `;
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          ...
          <p class="label-1">
          ${date.getDate()} ${module.monthNames[date.getUTCMonth()]}</p>
          <p class="label-1">
          ${module.weekDayNames[date.getUTCDay()]}</p>
        `;
